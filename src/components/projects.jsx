    ...
    <div className="p-3  text-gray-600 flex flex-col gap-3">
      <div className="flex justify-between flex-col gap-1">
        ...
        <p className="font-extralight text-sm">
          ...
          <span className="font-medium">RDS</span> for mysql database, terraform
          for infrastructure provisioning, and Jenkins for CICD. Both
          application and jenkins server running on separate EC2 instances
          provisioned by terraform. RDS instance is deployed in a private subnet
          for securing database, loadbalancer, hosted zone, certificate manager
          and s3 for terraform backend are other tech used
        </p>
        <a
      ...
      <div className="flex justify-between flex-col gap-1">
        ...
        <p className="font-extralight text-sm">
          A React application deployed in AWS using terraform for infrastructure
          provisioning, including security groups and ec2 instance. Jenkins for
          running multi-stage pipelines including{" "}
